...
chapters/506-systemd-deployment/exercise.md %}). Make the necessary changes to
...
PHP-FPM exercise]({% link chapters/512-nginx-php-fpm-deployment/exercise.md %}).
...
as [presented during the course]({% link chapters/509-reverse-proxy/subject.md
%}#reverse-proxy-configuration).

Similarly to the [multi-component exercise]({% link
chapters/511-revprod-deployment/exercise.md %}), you will need to define multiple
...
- A frontend with compiled static files. There is no port here; there are simply
  ...
  chapters/510-nginx-static-deployment/exercise.md %}). For this location, you
...
in the [certbot exercise]({% link chapters/514-certbot-deployment/exercise.md
%}).
...
chapters/602-git-automated-deployment/exercise.md %}).
