...
exercise]({% link chapters/410-sftp-deployment/exercise.md %}), but using Git to
...
chapters/410-sftp-deployment/exercise.md %}) first.
...
chapters/410-sftp-deployment/exercise.md %}#architecture)
