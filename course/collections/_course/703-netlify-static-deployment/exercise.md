---
title: Deploy static sites to Netlify
...
{% callout type: more, id: what-is-netlify %}
...
{% callout type: more, id: what-is-nodejs %}
...
- [nodenv][nodenv], [nvm][nvm], [n][n], [volta][volta]
- [asdf][asdf] & [mise][mise] (also support other platforms than Node.js)
...
{% callout type: more, id: what-is-npm %}
