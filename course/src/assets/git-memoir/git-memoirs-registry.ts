import {
  drawFileSystemExtensionPredicate,
      ...
      .chapter('staging', {
        before: function (_step, drawer) {
          ...
          drawer
            ...
            .getViewStrategy()
            .setDefaultIcon({ svg: getComputerIcon(), aspectRatio: 80 / 48 });
          drawer
            .requireExtension(drawFileSystemExtensionPredicate)
            .getViewStrategy()
            .setCustomIcon('github', { svg: getGithubIcon() });
        }
      })
      .fileSystem('bob', _fs => {}, {
        /*icon: {
