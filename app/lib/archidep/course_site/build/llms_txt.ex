defmodule ArchiDep.CourseSite.Build.LlmsTxt do
  ...
  defp header(urls, site_url, site) do
    ...
    > The course material of ArchiDep, the media engineering architecture and deployment course, #{site.years} edition.

    Home page: #{Urls.resolve!(urls, :home)}
  ...
  defp revision(%SiteInfo{git_revision: revision}), do: "\nBuilt from revision #{revision}.\n"
  ...
  defp summary(nil), do: ""
  defp summary(summary), do: [" ", summary]
