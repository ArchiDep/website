defmodule ArchiDep.Servers.Policy do
  ...
  def authorize(
      ...
      do: active and Enum.member?(roles, :student)

  # Root users can validate any server.
  def authorize(
        :servers,
        :validate_server,
        %Authentication{principal: %UserAccount{active: active, roles: roles}},
        _params
      ),
  ...
  def authorize(
      ...
      do: active and (Enum.member?(roles, :student) or Enum.member?(roles, :root))
  ...
  def authorize(
        :servers,
        :fetch_server,
        %Authentication{principal: %UserAccount{id: principal_id, active: active, roles: roles}},
