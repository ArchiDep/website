defmodule ArchiDep.Servers.Events.ServerReconnecting do
  @moduledoc false
  ...
  defimpl Event do
    ...
    @spec event_stream(ServerReconnecting.t()) :: String.t()
    def event_stream(%ServerReconnecting{id: id}),
      do: "servers:servers:#{id}"

    @spec event_type(ServerReconnecting.t()) :: atom()
    def event_type(_event), do: :"archidep/servers/server-reconnecting"
  end
end
