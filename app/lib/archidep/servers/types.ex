defmodule ArchiDep.Servers.Types do
  ...
  @type ansible_facts :: %{optional(String.t()) => term()}
  @type ansible_variables :: %{optional(String.t()) => term()}
  @type ansible_stats :: %{
  ...
  @type server_connection_refused_problem ::
          {:server_connection_refused, :inet.ip_address(), 1..65_535, String.t()}
  @type server_connection_timed_out_problem ::
          {:server_connection_timed_out, :inet.ip_address(), 1..65_535, String.t()}
