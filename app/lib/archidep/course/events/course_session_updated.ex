defmodule ArchiDep.Course.Events.CourseSessionUpdated do
  @moduledoc false
  ...
  defimpl Event do
    ...
    @spec event_stream(CourseSessionUpdated.t()) :: String.t()
    def event_stream(%CourseSessionUpdated{id: id}), do: "course:sessions:#{id}"

    @spec event_type(CourseSessionUpdated.t()) :: atom()
    def event_type(_event), do: :"archidep/course/session-updated"
  end
end
