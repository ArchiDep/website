  ...
  pipeline :browser do
    ...
    plug(:put_secure_browser_headers, %{
      "content-security-policy" =>
        "default-src 'self'; base-uri 'self'; frame-ancestors 'self'; connect-src 'self' plausible.alphahydrae.ch; font-src 'self' fonts.gstatic.com; img-src 'self' status.archidep.ch data:; script-src 'self' plausible.alphahydrae.ch; style-src-elem 'self' fonts.googleapis.com;"
    })
  ...
  scope "/", ArchiDepWeb do
    ...
    live_session :default, on_mount: [Flashy.Hook, ArchiDepWeb.LiveHooks] do
      ...
      scope "/admin" do
        ...
        live "/events/:id", Admin.Events.EventLive
      end
