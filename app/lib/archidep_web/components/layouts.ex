defmodule ArchiDepWeb.Components.Layouts do
  @moduledoc """
  This module holds the layouts used by the application.

  The "root" layout is a skeleton rendered as part of the application router (see
  the `layouts` directory). The "app" layout is a function component that wraps
  the content of controllers and live views with the application header,
  navigation sidebar and flash messages.
  """
  ...
  @doc """
  Renders the application shell (header, navigation sidebar and flash messages)
  around the given inner content.
  """
  attr :flash, :map, required: true, doc: "the map of flash messages"
  attr :auth, :any, required: true, doc: "the current authentication"
  attr :current_path, :string, required: true, doc: "the current request path"
  slot :inner_block, required: true, doc: "the page content to render"
